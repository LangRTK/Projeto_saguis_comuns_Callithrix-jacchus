...
#Habituação
print("Bem vindo ao programa de Método de discriminação de estímulos auditivos para primatas através do condicionamento operante!")
Legenda= print("SIM digite 1 NÃO digite 2")
habituacao=int(input("O animal está habituado?: "))
Legenda= print("SIM digite 1 NÃO digite 2")
if habituacao == 1:
    print("Animal habituado")
#Aproximação,toque na barra e emição de som
animal=30
aproximação=float(input("Digite o quanto o animal se aproximou: "))
if aproximação-animal < 30:
    agua=0,5
